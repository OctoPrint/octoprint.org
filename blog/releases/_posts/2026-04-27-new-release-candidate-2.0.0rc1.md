...
excerpt: The first release candidate for the upcoming 2.0.0 release that brings support for connection options other than serial, native thumbnail support, better integration of the printer's storage, multi-storage management, and of course also comes with improvements and bugfixes on top!
