...
<div class="grid grid-2 help">
    <div class="help-box">
        <h3>
            <a href="https://community.octoprint.org" target="_blank"><img src="help_title_forum.png" alt="Community Forum: community.octoprint.org"></a>
        </h3>
    ...
    <div class="help-box">
        <h3>
            <a href="https://discord.gg/yA7stPp" target="_blank"><img src="help_title_discord.png" alt="Discord: discord.octoprint.org"></a>
        </h3>
        <div class="help-content">
            <p>
...
**Those are the _only_ official support channels**. OctoPrint does not provide official support on the various social media platforms such as Facebook, Reddit, Twitter/X, etc. If you see OctoPrint support being offered on any other platform but the two options listed above, it is not official!

Please also be advised that we can not provide free support via email or any other private channel. With a project of this size, this simply does not scale.
**If you require individual 1:1 support, feel free to
[get in touch about paid consulting options: `consulting@octoprint.org`](mailto:consulting@octoprint.org).**
Be advised though that the available time for individual consulting is limited.
