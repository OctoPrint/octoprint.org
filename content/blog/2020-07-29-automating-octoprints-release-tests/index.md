...
tags:
- Development
summary: OctoPrint's release tests so far involved a lot of card juggling and 
  other manual steps with a lot of wasted time. Read how I was finally able to 
  automate this after a long journey.
slug: automating-octoprints-release-tests
---
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-07-29-release-checklist.png" alt="The partial release checklist of 1.4.1rc4" >}}
{{< /lightbox-grid >}}
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-07-29-testcluster.jpg" alt="The manually run test cluster" >}}
{{< /lightbox-grid >}}
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-07-29-prototype.jpg" alt="The prototype" >}}
{{< /lightbox-grid >}}
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-07-29-testrig.jpg" alt="The finished testrig" >}}
{{< /lightbox-grid >}}
