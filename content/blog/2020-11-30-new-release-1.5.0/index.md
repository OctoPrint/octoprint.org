...
- title: Access Control is now mandatory and no longer can be disabled
  content: >
    If you so far had Access Control disabled, upon upgrading to 1.5.0, OctoPrint
    will prompt
    you to create a user name and password for the (first) admin user. This step was
    sadly
    necessary as too many people still will happily expose their completely unsecured
    OctoPrint instance on the public internet, causing additional support overhead
    from both
    ...
    for a way to have OctoPrint log you in automatically when connecting from an internal
    IP.
...
tags:
- Release
summary: "After almost 4 months of development and a three week long RC phase, I'm
  proud to present you OctoPrint 1.5.0!"
slug: new-release-1.5.0
images:
- url: images/2020-11-10-screenshot-swu.png
  title: Release channels for third party plugins and individual notice 
    configuration.
- url: images/2020-11-10-screenshot-systeminfo.png
  title: New system information screen gives access to help in support and bug 
    reports.
- url: images/2020-11-10-screenshot-recovery.png
  title: Recovery dialog gives access to system commands, backups and system 
    info, as well as basic printer control (if connected).
- url: images/2020-11-10-screenshot-timelapse-player.png
