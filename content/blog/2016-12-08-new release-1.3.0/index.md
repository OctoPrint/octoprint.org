...
tags:
- Release
summary: After over a year of work and overshadowed by a full blown project 
  funding crisis, today the much anticipated 1.3.0 release finally sees the 
  light of day!
slug: new release-1.3.0
images:
- url: images/2016-10-19-folders.png
  title: The new folder support
- url: images/2016-10-19-wizard.png
  title: The new wizard dialog system in action
- url: images/2016-10-19-ui-example-mrbeam.png
  title: A custom UI by Mr Beam tailored to their laser cutter, done through a 
    UiPlugin
- url: images/2016-10-19-ui-example-leapfrog.png
  title: A custom UI by Leapfrog for their printers, done through a UiPlugin
- url: images/2016-10-19-ui-example-forcelogin.png
  title: A login-only view forced for logged out/anonymous users, done through a
    UiPlugin
- url: images/2016-11-24-bounding-box.png
  title: Configuring a custom safe bounding box
- url: images/2016-11-24-firmware-detection.gif
