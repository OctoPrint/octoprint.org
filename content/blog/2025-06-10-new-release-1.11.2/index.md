...
headsups:
- title: "🧩 `SimpleApiPlugin`s can now opt-into enforced authentication on their endpoints,
    a future version of OctoPrint will require an opt-out to prevent this"
  content: |
...
tags:
- Release
summary: "The second bugfix release for 1.11.x, fixing some bugs, security issues
  and user experience problems reported since the release of 1.11.0."
slug: new-release-1.11.2
release: 1.11.2
stable:
  tag: 1.11.0
