...
- title: "Heads-up for plugin authors: Importing Jinja2 templates from another plugin
    without an explicit prefix is now deprecated!"
  content: |
...
- title: "Heads-up for plugin authors: `octoprint.util.bom_aware_open` is now deprecated
...
- title: "Heads-up for plugin authors: `octoprint.util.commandline.clean_ansi` will
    no longer accept `bytes` in 2.0.0"
  content: |
...
tags:
- Release
summary: The first release candidate for the upcoming 1.8.0 release, containing 
  new features, improvements, bug fixes and dropping Python 2 support!
slug: new-release-candidate-1.8.0rc1
images:
