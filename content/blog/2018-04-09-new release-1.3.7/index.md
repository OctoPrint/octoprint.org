...
tags:
- Release
summary: After several months of work I'm happy to present you OctoPrint 1.3.7. 
  This a true maintenance release again, consisting of various improvements and 
  fixes.
slug: new release-1.3.7
images:
- url: images/2018-04-09-serial_settings_ui_overhaul.gif
  title: The serial settings got an UI overhaul to be hopefully less cluttered 
    and overwhelming
- url: images/2018-04-09-safetycheck.png
  title: A new bundled plugin "Printer Safety Check" will warn you if your 
    printer's firmware is known to have safety issues.
---
