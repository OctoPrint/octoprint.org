...
tags:
- Release
summary: "Fresh off the presses, just through a month long release candidate cycle
  and the first one to be developed during a raging pandemic, I present you the next
  stable release of OctoPrint: 1.4.1!"
slug: new-release-1.4.1
images:
- url: images/2020-07-06-temperature-profiles.png
  title: Temperature profile selector for all heaters
- url: images/2020-07-06-file-move.png
  title: Move files right from the file list
- url: images/2020-07-06-pmgr-repo-browser.png
  title: The plugin manager now shows stats for the plugins on the plugin 
    repository and allows to install single file plugins
- url: images/2020-07-06-pmgr-overview.png
  title: The plugin manager also now shows more information about the installed 
    plugins, including their Python compatibility
---
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-08-04-rc-instances.png" alt="1.4.1rc instances over the past month, per hour" >}}
{{< lightbox image="images/2020-08-04-rc-prints.png" alt="Accumulated 1.4.1rc print times over the past month, per hour" >}}
{{< lightbox image="images/2020-08-04-rc-pies.png" alt="1.4.1rc instances and accumulated print time over the past month, total" >}}
{{< /lightbox-grid >}}
...
- [Contribution Guidelines (also relevant for creating bug reports!)](https://github.com/OctoPrint/OctoPrint/blob/dev/CONTRIBUTING.md)
- [How to file a bug report](https://github.com/OctoPrint/OctoPrint/blob/dev/CONTRIBUTING.md#how-to-file-a-bug-report)
