...
tags:
- Release
summary: "This fourth bugfix release for 1.8.0 fixes a few newly reported issues and
  introduces a reverse proxy test page."
slug: new-release-1.8.4
release: 1.8.4
stable:
  tag: 1.8.0
  ...
  headsups: true
images:
- url: images/2022-09-27-screenie-reverse-proxy-test-yay.png
  title: OctoPrint's new reverse proxy test page. All checks are green.
- url: images/2022-09-27-screenie-reverse-proxy-test-nay.png
  title: OctoPrint's new reverse proxy test page. There's a mismatch in 
    Protocol, Port, Path and thus Cookie Suffix between client and server that 
    the test page marks as failed check.
---
