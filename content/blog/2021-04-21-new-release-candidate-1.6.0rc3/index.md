...
tags:
- Release
summary: The third release candidate for the upcoming 1.6.0 release, with a one 
  fix of a regression and one work around for a discovered firmware bug.
slug: new-release-candidate-1.6.0rc3
---
