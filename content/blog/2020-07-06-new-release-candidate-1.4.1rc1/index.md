...
tags:
- Release
summary: The first release candidate for the upcoming 1.4.1 release, with 
  improvements and fixes!
slug: new-release-candidate-1.4.1rc1
images:
...
As the past RCs have shown me that a lot of people appear to be unaware of this: **Please do _not_ install this RC if you
expect a fully stable version**. It is not a stable release, it is a release _candidate_, and of the next big release
...
You should feel comfortable with and capable of possibly having to do this _before_ installing an RC.
