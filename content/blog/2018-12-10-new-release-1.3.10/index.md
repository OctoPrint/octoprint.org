...
tags:
- Release
summary: After four weeks of testing by the community and just in time for the 
  holidays, I'm happy to present you OctoPrint 1.3.10. While this is a 
  maintenance release, it not only packs a bunch of bug fixes but also a whole 
  lot of improvements, including the new Backup & Restore plugin and Application
  Keys plugin.
slug: new-release-1.3.10
images:
- url: images/2018-11-06-octoprint-1.3.10rc1-pisupport.png
  title: The new warning symbols of the Pi Support plugin when undervoltage and 
    overheating are detected.
- url: images/2018-11-06-octoprint-1.3.10rc1-backup.png
  title: The new Backup & Restore Plugin.
- url: images/2018-11-06-octoprint-1.3.10rc1-appkeys_notification.png
  title: An access request notification generated by the new Application Keys 
    Plugin...
- url: images/2018-11-06-octoprint-1.3.10rc1-appkeys_usersettings.png
  title: '... and the new user settings dialog for management of all your Application
    Keys.'
- url: images/2018-11-06-octoprint-1.3.10rc1-forcedlogin.png
  title: The new ForcedLogin makes sure anonymous users will no longer be able 
    to watch your prints.
---
