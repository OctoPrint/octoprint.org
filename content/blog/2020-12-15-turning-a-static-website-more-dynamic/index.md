...
tags:
- Development
summary: Since its creation in 2015 the OctoPrint plugin repository has been a 
  static page powered by Jekyll. Read how over the course of 2020 it got more 
  dynamic through the power of GitHub Actions.
slug: turning-a-static-website-more-dynamic
---
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-12-15-static-more-dynamic-build.png" alt="An example run of the custom build workflow" >}}
{{< /lightbox-grid >}}
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-12-15-static-more-dynamic-usage.png" alt="An example run of the custom build workflow" >}}
{{< /lightbox-grid >}}
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-12-15-static-more-dynamic-plugin.png" alt="Each plugin's detail page now offers usage data and - if the plugin is hosted on GitHub - also additional development activity metadata and starring support" >}}
{{< /lightbox-grid >}}
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-12-15-static-more-dynamic-top10.png" alt="Popular and trending plugins are presented on the repository home page" >}}
{{< /lightbox-grid >}}
...
{{< lightbox-grid >}}
{{< lightbox image="images/2020-12-15-static-more-dynamic-octoprint.png" alt="The enriched data is also fed back into OctoPrint's plugin repository browser" >}}
{{< /lightbox-grid >}}
