...
headsups:
- title: 🔒 If you use autologin and have additional reverse proxies in front of 
    OctoPrint, make sure they are configured correctly
  content: |
...
tags:
- Release
summary: "The first bugfix & security release for 1.10.x, fixing one security vulnerability,
  several bugs and also adding the one or other improvement."
slug: new-release-1.10.1
release: 1.10.1
stable:
  tag: 1.10.0
