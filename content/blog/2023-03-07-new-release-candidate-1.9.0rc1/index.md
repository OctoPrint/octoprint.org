...
headsups:
- title: "Heads-up: OctoPrint's web interface now requires ES9 (EcmaScript 2018) support
    in your browser"
  content: |
...
- title: "Heads-up for plugin and third party application developers: Webcam integration
    has moved to a plugin interface"
  content: |
...
tags:
- Release
summary: The first release candidate for the upcoming 1.9.0 release containing 
  new features, improvements & bug fixes!
slug: new-release-candidate-1.9.0rc1
images:
- url: images/2023-03-07-gif-multicam.gif
  title: Multiple registered webcam views can be switched in the Control tab.
- url: images/2023-03-07-screenshot-chartmarked.png
  title: The markers on the temperature graph can now be extended by plugins 
    through a new event. Here you can see how the BedCooldown plugin by @rfinnie
    makes use of that to add a Cooldown marker.
- url: images/2023-03-07-gif-port-autorefresh.gif
  title: The port list will now autorefresh while no connection the a printer 
    has yet been established.
- url: images/2023-03-07-screenshot-announcements-bubble.png
  title: Announcements will no longer trigger a popup (apart from priority 
    announcements), but rather show up as a counter in the navbar.
- url: images/2023-03-07-screenshot-announcements-viewer.png
  title: The announcement viewer has been extended by a "Unread" tab and a "Mark
    all read" button.
---

> [!NOTE]
> No matter how much you test, sometimes something slips through. 1.9.0rc2 is incoming due to the `octoprint_setuptools` refactoring breaking most plugin installs on 1.9.0rc1 after all. Sorry for the inconvenience, ~~new RC asap~~1.9.0rc2 has been pushed to fix this!
