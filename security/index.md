...
lastupdate: 2025-09-02 10:15:00 +0200
---
...
- Reports from automated tools or scanners, or generated by some kind of AI tool
...
If you are familiar with [CVSS4.0](https://www.first.org/cvss/v4-0/specification-document), then please provide the score of the vulnerability in your report in the shape of a vector string. There's a calculator [here](https://www.first.org/cvss/calculator/4-0). If you are not sure how or unable to score a vulnerability, state that in your report and we will look into it.

If you intend to provide a score yourself, please make yourself familiar with CVSS _first_ (we strongly recommend reading [Specification](https://www.first.org/cvss/v4.0/specification-document) and [Assessment Guide](https://www.first.org/cvss/v4-0/user-guide#Assessment-Guide)), as we will not accept reports that use it incorrectly.
